...
$\begin{array}{c}
\Qcircuit @C=.5em @R=.8em {
\lstick{q_1 \ket{x}} & \ctrl{5} & \ctrl{10} & \gate{H} & \ctrl{1} & \ctrl{2}  & \ctrl{3} & \qw      & \ctrl{4} & \qw      & \targ     & \qw       & \qw         & \ctrl{2} & \ctrl{1} & \gate{H}  & \qw       & \ctrl{15} & \qw       & \ctrl{16} & \qw      & \gate{H} & \control \qw & \qw          & \qw          & \gate{H} & \ctrl{10} & \ctrl{5} & \qw    & \push{U\ket{x}}{1em} \\
\lstick{q_2 \ket{0}} & \qw      & \qw       & \qw      & \targ    & \qw       & \qw      & \ctrl{2} & \qw      & \qw      & \qw       & \targ     & \qw         & \qw      & \targ    & \qw       & \qw       & \qw       & \qw       & \qw       & \qw      & \qw      & \qw          & \qw          & \qw          & \qw      & \qw       & \qw      & \qw    & \ket{0}  \\
\lstick{q_3 \ket{0}} & \qw      & \qw       & \qw      & \qw      & \targ     & \qw      & \qw      & \qw      & \ctrl{2} & \qw       & \qw       & \targ       & \targ    & \qw      & \qw       & \qw       & \qw       & \qw       & \qw       & \qw      & \qw      & \qw          & \qw          & \qw          & \qw      & \qw       & \qw      & \qw    & \ket{0}  \\
                     &          &           &          &          & \inita{1} & \targ    & \targ    & \qw      & \qw      & \ctrl{-3} & \ctrl{-2} & \ctrlo{-1}  & \qw      & \qw      & \meter    & s_1       &           &           &           &          &          &              &              &              &          &           &          &        &          \\
                     &          &           &          &          & \inita{2} & \qw      & \qw      & \targ    & \targ    & \ctrl{-4} & \ctrlo{-3} & \ctrl{-2}  & \qw      & \qw      & \meter    & s_2       &           &           &           &          &          &              &              &              &          &           &          &        &          \\
\lstick{q_4 \ket{0}} & \targ    & \qw       & \gate{H} & \ctrl{1} & \ctrl{2}  & \ctrl{3} & \qw      & \ctrl{4} & \qw      & \targ     & \qw        & \qw        & \ctrl{2} & \ctrl{1} & \gate{H}  & \qw       & \qw       & \ctrl{10} & \qw       & \qw      & \gate{H} & \qw          & \control \qw & \qw          & \gate{H} & \qw       & \targ    & \qw    & \ket{0}  \\
\lstick{q_5 \ket{0}} & \qw      & \qw       & \qw      & \targ    & \qw       & \qw      & \ctrl{2} & \qw      & \qw      & \qw       & \targ      & \qw        & \qw      & \targ    & \qw       & \qw       & \qw       & \qw       & \qw       & \qw      & \qw      & \qw          & \qw          & \qw          & \qw      & \qw       & \qw      & \qw    & \ket{0}  \\
\lstick{q_6 \ket{0}} & \qw      & \qw       & \qw      & \qw      & \targ     & \qw      & \qw      & \qw      & \ctrl{2} & \qw       & \qw        & \targ      & \targ    & \qw      & \qw       & \qw       & \qw       & \qw       & \qw       & \qw      & \qw      & \qw          & \qw          & \qw          & \qw      & \qw       & \qw      & \qw    & \ket{0}  \\
                     &          &           &          &          & \inita{3} & \targ    & \targ    & \qw      & \qw      & \ctrl{-3} & \ctrl{-2}  & \ctrlo{-1} & \qw      & \qw      & \meter    & s_3       &           &           &           &          &          &              &              &              &          &           &          &        &          \\
                     &          &           &          &          & \inita{4} & \qw      & \qw      & \targ    & \targ    & \ctrl{-4} & \ctrlo{-3} & \ctrl{-2}  & \qw      & \qw      & \meter    & s_4       &           &           &           &          &          &              &              &              &          &           &          &        &          \\
\lstick{q_7 \ket{0}} & \qw      & \targ     & \gate{H} & \ctrl{1} & \ctrl{2}  & \ctrl{3} & \qw      & \ctrl{4} & \qw      & \targ     & \qw        & \qw        & \ctrl{2} & \ctrl{1} & \gate{H}  & \qw       & \qw       & \qw       & \qw       & \ctrl{6} & \gate{H} & \qw          & \qw          & \control \qw & \gate{H} & \targ     & \qw      & \qw    & \ket{0}  \\
\lstick{q_8 \ket{0}} & \qw      & \qw       & \qw      & \targ    & \qw       & \qw      & \ctrl{2} & \qw      & \qw      & \qw       & \targ      & \qw        & \qw      & \targ    & \qw       & \qw       & \qw       & \qw       & \qw       & \qw      & \qw      & \qw          & \qw          & \qw          & \qw      & \qw       & \qw      & \qw    & \ket{0}  \\
\lstick{q_9 \ket{0}} & \qw      & \qw       & \qw      & \qw      & \targ     & \qw      & \qw      & \qw      & \ctrl{2} & \qw       & \qw        & \targ      & \targ    & \qw      & \qw       & \qw       & \qw       & \qw       & \qw       & \qw      & \qw      & \qw          & \qw          & \qw          & \qw      & \qw       & \qw      & \qw    & \ket{0}  \\
                     &          &           &          &          & \inita{5} & \targ    & \targ    & \qw      & \qw      & \ctrl{-3} & \ctrl{-2}  & \ctrlo{-1} & \qw      & \qw      & \meter    & s_5       &           &           &           &          &          &              &              &              &          &           &          &        &          \\
                     &          &           &          &          & \inita{6} & \qw      & \qw      & \targ    & \targ    & \ctrl{-4} & \ctrlo{-3} & \ctrl{-2}  & \qw      & \qw      & \meter    & s_6       &           &           &           &          &          &              &              &              &          &           &          &        &          \\
