...
$SCRIPT --filename=$IMAGEDIR/1ket_I_bit0.png --theta=pi --flip=0
echo "Input state: |1>, I, flip bit 1"
$SCRIPT --filename=$IMAGEDIR/1ket_I_bit1.png --theta=pi --flip=1
echo "Input state: |1>, I, flip bit 2"
$SCRIPT --filename=$IMAGEDIR/1ket_I_bit2.png --theta=pi --flip=2
...
$SCRIPT --filename=$IMAGEDIR/1ket_X_bit0.png --theta=pi --unitaryop=X --flip=0
echo "Input state: |1>, X, flip bit 1"
$SCRIPT --filename=$IMAGEDIR/1ket_X_bit1.png --theta=pi --unitaryop=X --flip=1
echo "Input state: |1>, X, flip bit 2"
$SCRIPT --filename=$IMAGEDIR/1ket_X_bit2.png --theta=pi --unitaryop=X --flip=2
...
$SCRIPT --filename=$IMAGEDIR/3366ket_I_bit0.png --theta="2*atan(sqrt(2))" --flip=0
echo "Input state: |33:66>, I, flip bit 1"
$SCRIPT --filename=$IMAGEDIR/3366ket_I_bit1.png --theta="2*atan(sqrt(2))" --flip=1
echo "Input state: |33:66>, I, flip bit 2"
$SCRIPT --filename=$IMAGEDIR/3366ket_I_bit2.png --theta="2*atan(sqrt(2))" --flip=2
...
$SCRIPT --filename=$IMAGEDIR/3366ket_X_bit0.png --theta="2*atan(sqrt(2))" --unitaryop=X --flip=0
echo "Input state: |33:66>, X, flip bit 1"
$SCRIPT --filename=$IMAGEDIR/3366ket_X_bit1.png --theta="2*atan(sqrt(2))" --unitaryop=X --flip=1
echo "Input state: |33:66>, X, flip bit 2"
$SCRIPT --filename=$IMAGEDIR/3366ket_X_bit2.png --theta="2*atan(sqrt(2))" --unitaryop=X --flip=2
