...
$SCRIPT --filename=$IMAGEDIR/1ket_I_phase0.png --ry=pi --flip=0
echo "Input state: |1>, I, flip bit 1"
$SCRIPT --filename=$IMAGEDIR/1ket_I_phase1.png --ry=pi --flip=1
echo "Input state: |1>, I, flip bit 2"
$SCRIPT --filename=$IMAGEDIR/1ket_I_phase2.png --ry=pi --flip=2
echo "Input state: |1>, X, no error"
$SCRIPT --filename=$IMAGEDIR/1ket_X_none.png --ry=pi --unitaryop=X
echo "Input state: |1>, X, flip bit 0"
$SCRIPT --filename=$IMAGEDIR/1ket_X_phase0.png --ry=pi --unitaryop=X --flip=0
echo "Input state: |1>, X, flip bit 1"
$SCRIPT --filename=$IMAGEDIR/1ket_X_phase1.png --ry=pi --unitaryop=X --flip=1
echo "Input state: |1>, X, flip bit 2"
$SCRIPT --filename=$IMAGEDIR/1ket_X_phase2.png --ry=pi --unitaryop=X --flip=2
...
$SCRIPT --filename=$IMAGEDIR/3366ket_I_phase0.png --ry="2*atan(sqrt(2))" --flip=0
echo "Input state: |33:66>, I, flip bit 1"
$SCRIPT --filename=$IMAGEDIR/3366ket_I_phase1.png --ry="2*atan(sqrt(2))" --flip=1
echo "Input state: |33:66>, I, flip bit 2"
$SCRIPT --filename=$IMAGEDIR/3366ket_I_phase2.png --ry="2*atan(sqrt(2))" --flip=2
...
$SCRIPT --filename=$IMAGEDIR/3366ket_X_phase0.png --ry="2*atan(sqrt(2))" --unitaryop=X --flip=0
echo "Input state: |33:66>, X, flip bit 1"
$SCRIPT --filename=$IMAGEDIR/3366ket_X_phase1.png --ry="2*atan(sqrt(2))" --unitaryop=X --flip=1
echo "Input state: |33:66>, X, flip bit 2"
$SCRIPT --filename=$IMAGEDIR/3366ket_X_phase2.png --ry="2*atan(sqrt(2))" --unitaryop=X --flip=2
